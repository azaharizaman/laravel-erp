...
return [
    ...
    'models' => [
        'item' => \Nexus\InventoryManagement\Models\Item::class,
        ...
        // Transaction models
        'transactions' => [
            'opening_balance' => \Nexus\InventoryManagement\Models\Transactions\OpeningBalance::class,
            'stock_in' => \Nexus\InventoryManagement\Models\Transactions\StockIn::class,
            'stock_out' => \Nexus\InventoryManagement\Models\Transactions\StockOut::class,
            'stock_transfer' => \Nexus\InventoryManagement\Models\Transactions\StockTransfer::class,
            'stock_adjustment' => \Nexus\InventoryManagement\Models\Transactions\StockAdjustment::class,
        ],
    ],
