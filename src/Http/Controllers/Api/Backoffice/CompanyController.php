...
namespace Nexus\Erp\Http\Controllers\Api\Backoffice;

use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Nexus\Erp\Actions\Backoffice\CreateCompanyAction;
use Nexus\Erp\Actions\Backoffice\UpdateCompanyHierarchyAction;
use Nexus\Erp\Actions\Backoffice\GenerateOrganizationalChartAction;
use Nexus\Erp\Http\Requests\Api\Backoffice\StoreCompanyRequest;
use Nexus\Erp\Http\Requests\Api\Backoffice\UpdateCompanyRequest;
use Nexus\Erp\Http\Resources\Api\Backoffice\CompanyResource;
