...
| TASK-008 | Create composer.json at `packages/notifications/composer.json` with package name "azaharizaman/erp-notifications", namespace "Azaharizaman\\Erp\\Notifications", require PHP ^8.2, laravel/framework ^12.0, azaharizaman/erp-core ^1.0, lorisleiva/laravel-actions ^2.0, autoload PSR-4, service provider registration | | |
